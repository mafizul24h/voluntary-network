                ...
                <form onSubmit={handleAddEvent}>
                    <div className='row row-cols-1 row-cols-lg-2'>
                        <div className="form-group mb-2">
                            ...
                            <input type="text" name='title' className="form-control" placeholder="Enter Event" required />
                        </div>
                        <div className="form-group mb-2">
                            <label className='fw-bold'>Event Date</label>
                            <input type="date" name='date' className="form-control" placeholder="Enter Date" required />
                        </div>
                        <div className="form-group mb-2">
                            <label className='fw-bold'>Event Description</label>
                            <textarea className="form-control" name="description" placeholder="Enter Description" cols="10" rows="2" required></textarea>
                        </div>
                        <div className="form-group mb-2">
                            <label className='fw-bold'>Event Banner</label>
                            <input type="file" name='banner' onChange={(e) => setImage(e.target.files[0])} className="form-control" placeholder="Enter Banner" required />
                        </div>
                    </div>
